...
class Basic : public RendererOSX {
 ...
 //   GLint colLoc = 1;
  ...
  CaptureManager* cm;
  aluminum::Texture* captureTexture;

  
  
  void loadTexture(aluminum::Texture& t, const std::string& name) {
  ...
  virtual void onCreate() {
    ...
    */
    ...
    captureTexture = new aluminum::Texture(640, 480, GL_RGBA, GL_RGB, GL_UNSIGNED_BYTE);
  //  [cm startCapture:captureTexture];
    
    
   // loadTexture(captureTexture, "Resources/mak.png");
