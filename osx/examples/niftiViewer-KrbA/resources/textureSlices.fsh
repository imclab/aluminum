...
void main() {
  ...
  // vec3 cluster1_color = vec3(1.0,0.25,0.55);
  // vec3 cluster2_color = vec3(0.5,1.0,0.25);
  // vec3 cluster3_color = vec3(0.25,0.5,1.0);
  ...
  if (useCluster1 == 1 && useCluster2 == 1 && useCluster3 == 1) {
    if (setColor(percent, c1_t1, c1_t2, c1_t3, cluster1_color, clusterColorA) ||
        ...
        setColor(percent, c3_t1, c3_t2, c3_t3, cluster3_color, clusterColorC)) {
    ...
    if (setColor(percent, c3_t1, c3_t2, c3_t3, cluster3_color, clusterColorC)) {
